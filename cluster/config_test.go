...
func getAppConfig() cluster.AppConfig {
	return cluster.AppConfig{
		Config: &cluster.HetznerConfig{
			Contexts: []cluster.HetznerContext{
				{Name: firstContext},
				{Name: secondContext},
			},
		},
...
func getCloudProvider() cluster.HetznerConfig {
	return cluster.HetznerConfig{
